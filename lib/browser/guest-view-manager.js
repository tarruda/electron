...
const shouldEnableSandbox = function (embedder, params) {
  return (params && params.sandbox) || (
    embedder.browserWindowOptions &&
    embedder.browserWindowOptions.webPreferences &&
    embedder.browserWindowOptions.webPreferences.sandbox)
}
...
const createGuest = function (embedder, params) {
  ...
  const guest = webContents.create({
    ...
    embedder: embedder,
    sandbox: shouldEnableSandbox(embedder, params)
  })
